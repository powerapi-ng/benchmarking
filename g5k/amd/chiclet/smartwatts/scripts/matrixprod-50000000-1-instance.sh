...
for i in {1..20}
do
	docker run --rm --name "matrixprod-50000000-op-1-instance" ghcr.io/colinianking/stress-ng --cpu 0 --cpu-method matrixprod --cpu-ops 50000000 --times >> result-matrixprod-50000000-op-1-instance-$(date +"%FT%H%M").txt
done
